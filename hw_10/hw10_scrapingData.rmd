...
<div>
<img src=media/yearRelease_rating.png align="left" height="50%" width="50%">
<img src=media/rating_noVotes.png align="right" height="50%" width="50%>
</div>
<p> </p>
...
Due to issues with memory, the top 25 movies are subsetted and saved into a second tsv file. This work is done in the following rScript - to avoid long lagging time when rendering the rmarkdown. I used for loops to pull the data for the first 25 indexed values to avoid manual coding of url links.
